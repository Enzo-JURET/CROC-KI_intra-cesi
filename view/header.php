...
<nav id="NavBar" class="col-sm-12 navbar NavBar">
    ...
    <input type="search" id="barre-recherche" name="q" aria-label="rechercher une personne">
    <input class="bouton-rechercher" type="submit" name="rechercher" value="Rechercher">
